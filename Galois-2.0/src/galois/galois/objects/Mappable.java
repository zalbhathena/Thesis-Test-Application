 ...
 * rather through {@link galois.galois.runtime.GaloisRuntime#foreach(Mappable, LambdaVoid)}
...
public interface Mappable<T> {
   ...
   * 
   * @see galois.galois.runtime.GaloisRuntime#foreach(Mappable, LambdaVoid)
   ...
   * Not intended to be called directly.
   * 
   * @see galois.galois.runtime.GaloisRuntime#foreach(Mappable, Lambda2Void, Object)
   * @param body  function to apply to each element
   ...
   * Not intended to be called directly.
   * 
   * @see galois.galois.runtime.GaloisRuntime#foreach(Mappable, Lambda3Void, Object, Object)
   * @param body  function to apply to each element
   * @param arg1  additional argument to function
