 ...
 * The Class OR2.
 */
public class OR2 extends TwoInputGate {

  /**
   * Instantiates a new OR2.
   *
   ...
   */
  public OR2(String outputName, String input1Name, String input2Name, long delay) {
  ...
  public char evalOutput() {
    return LogicFunctions.or(input1Val, input2Val);
  }
