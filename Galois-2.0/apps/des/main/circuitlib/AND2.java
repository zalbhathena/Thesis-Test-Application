...
/**
 * The Class AND2 represents a two input AND gate.
 */
public class AND2 extends TwoInputGate {

  /**
   * Instantiates a new AND2 gate
   *
   ...
   */
  public AND2(String outputName, String input1Name, String input2Name, long delay) {
    super(outputName, input1Name, input2Name, delay);
  }

  /**
   * Instantiates a new AND2.
   */
  public AND2() {
    super();
  }
  ...
  public char evalOutput() {
    return LogicFunctions.and(input1Val, input2Val);
  }
