 ...
 * The Class XNOR2.
 */
public class XNOR2 extends TwoInputGate {

  /**
   * Instantiates a new XNOR2.
   *
   ...
   */
  public XNOR2(String outputName, String input1Name, String input2Name, long delay) {
  ...
  public char evalOutput() {
    return LogicFunctions.not(LogicFunctions.xor(input1Val, input2Val));
  }
