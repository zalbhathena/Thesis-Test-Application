...
public final class GaloisRuntime {
   ...
   * @see #foreach(Mappable, Lambda2Void, galois.galois.runtime.wl.Priority.Rule)
   */
   ...
   * @throws ExecutionException  if there is an uncaught exception during execution
   * @see #foreach(Mappable, LambdaVoid)
   * @see #foreach(Iterable, Lambda2Void, galois.galois.runtime.wl.Priority.Rule)
   */
   ...
   * @param priority  specification of the order elements are processed
   * @throws ExecutionException  if there is an uncaught exception during execution
   * @see #foreachOrdered(Mappable, Lambda2Void, galois.galois.runtime.wl.Priority.Rule)
   */
   ...
   * @param priority  specification of the order elements are processed
   * @throws ExecutionException  if there is an uncaught exception during execution
   * @see #foreachOrdered(Iterable, Lambda2Void, galois.galois.runtime.wl.Priority.Rule)
   */
   ...
   * {@link #foreach(Mappable, Lambda2Void, galois.galois.runtime.wl.Priority.Rule)},
